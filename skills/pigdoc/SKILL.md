---
name: pigdoc
description: 搜索 PIG 官方文档并总结答案。当用户询问 PIG CLOUD、PIG AI、pigx 相关的技术问题、配置方法、功能说明，或明确说“查文档”、“搜一下”、“怎么配置”、“怎么实现”时触发。遇到 PIG 框架相关具体问题时应主动搜索文档后再回答，不要依赖训练数据中可能过期的信息。Use when the user runs /pigdoc.
---
